...
BASE = [  # (라벨, ho 접두, 컨트롤러 폴더명)
    ("NC",      "ho_nc",     "NO-CONTROL"),
    ("PFO",     "ho_pfo",    "WU-FAITHFUL-FOLLOWER"),
    ("P-Stack", "ho_pstack", "P-STACK-WU-FAITHFUL-ALLPRICE-JOINT"),
    ("P-CENT",  "ho_pcent",  "P-CENT"),
]
...
if __name__ == "__main__":
    p = sys.argv[1] if len(sys.argv) > 1 else str(ROOT / "rl_leader" / "actor_sac_continuous.pt")
